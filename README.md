okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/game-for-one/okex.svg)](https://pkg.go.dev/github.com/game-for-one/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/amir-the-h/okex.svg)](https://github.com/game-for-one/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/game-for-one/okex)](https://goreportcard.com/report/github.com/game-for-one/okex)
[![GitHub license](https://img.shields.io/github/license/amir-the-h/okex.svg)](https://github.com/game-for-one/okex/blob/main/LICENSE)
...
[![CI](https://github.com/game-for-one/okex/actions/workflows/main.yml/badge.svg)](https://github.com/game-for-one/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/game-for-one/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/game-for-one/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/game-for-one/okex/actions/workflows/release.yml/badge.svg)](https://github.com/game-for-one/okex/actions/workflows/release.yml)
...
```bash
go get github.com/game-for-one/okex@v1.1.4-alpha
```
...
import (
  ...
  "github.com/game-for-one/okex/api"
  "github.com/game-for-one/okex/events"
  "github.com/game-for-one/okex/events/public"
  ws_public_requests "github.com/game-for-one/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/game-for-one/okex/wiki/Handling-WS-events) 
